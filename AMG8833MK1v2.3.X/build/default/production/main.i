...
void AMG8833_GetData(void);
float Wertdetekt(void);
# 46 "main.c" 2


extern float DataMatrix[8][8];
extern float Temp_Data[64];
...
void main(void){
    ...
    while (1){
        AMG8833_GetData();
# 90 "main.c"
        printf("%.1f %.1f %.1f %.1f %.1f %.1f %.1f %.1f\r\n",DataMatrix[0][0],DataMatrix[0][1],DataMatrix[0][2],DataMatrix[0][3],DataMatrix[0][4],DataMatrix[0][5],DataMatrix[0][6],DataMatrix[0][7]);

        printf("%.1f %.1f %.1f %.1f %.1f %.1f %.1f %.1f\r\n",DataMatrix[1][0],DataMatrix[1][1],DataMatrix[1][2],DataMatrix[1][3],DataMatrix[1][4],DataMatrix[1][5],DataMatrix[1][6],DataMatrix[1][7]);

        printf("%.1f %.1f %.1f %.1f %.1f %.1f %.1f %.1f\r\n",DataMatrix[2][0],DataMatrix[2][1],DataMatrix[2][2],DataMatrix[2][3],DataMatrix[2][4],DataMatrix[2][5],DataMatrix[2][6],DataMatrix[2][7]);

        printf("%.1f %.1f %.1f %.1f %.1f %.1f %.1f %.1f\r\n",DataMatrix[3][0],DataMatrix[3][1],DataMatrix[3][2],DataMatrix[3][3],DataMatrix[3][4],DataMatrix[3][5],DataMatrix[3][6],DataMatrix[3][7]);

        printf("%.1f %.1f %.1f %.1f %.1f %.1f %.1f %.1f\r\n",DataMatrix[4][0],DataMatrix[4][1],DataMatrix[4][2],DataMatrix[4][3],DataMatrix[4][4],DataMatrix[4][5],DataMatrix[4][6],DataMatrix[4][7]);

        printf("%.1f %.1f %.1f %.1f %.1f %.1f %.1f %.1f\r\n",DataMatrix[5][0],DataMatrix[5][1],DataMatrix[5][2],DataMatrix[5][3],DataMatrix[5][4],DataMatrix[5][5],DataMatrix[5][6],DataMatrix[5][7]);

        printf("%.1f %.1f %.1f %.1f %.1f %.1f %.1f %.1f\r\n",DataMatrix[6][0],DataMatrix[6][1],DataMatrix[6][2],DataMatrix[6][3],DataMatrix[6][4],DataMatrix[6][5],DataMatrix[6][6],DataMatrix[6][7]);

        printf("%.1f %.1f %.1f %.1f %.1f %.1f %.1f %.1f\r\n",DataMatrix[7][0],DataMatrix[7][1],DataMatrix[7][2],DataMatrix[7][3],DataMatrix[7][4],DataMatrix[7][5],DataMatrix[7][6],DataMatrix[7][7]);
        printf("\r\n");
        printf("\r\n");
        printf("\r\n");
