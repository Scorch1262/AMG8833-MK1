...
float Temp_Data[64];
uint8_t readBuffer[3] = {0x00, 0x00, 0x00};

void AMG8833_Init(void) {

    I2C_Write1ByteRegister(0x69, 0x00, 0x00);
    I2C_Write1ByteRegister(0x69, 0x01, 0x30);
    I2C_Write1ByteRegister(0x69, 0x02, 0x00);
    _delay((unsigned long)((100)*(16000000/4000.0)));

    I2C_Write1ByteRegister(0x69, 0x08, 0x30);
    I2C_Write1ByteRegister(0x69, 0x09, 0x00);

    I2C_Write1ByteRegister(0x69, 0x0A, 0x15);
    I2C_Write1ByteRegister(0x69, 0x0B, 0x00);

    I2C_Write1ByteRegister(0x69, 0x0C, 0x20);
    I2C_Write1ByteRegister(0x69, 0x0D, 0x00);
    _delay((unsigned long)((100)*(16000000/4000.0)));
}
...
void AMG8833_GetData(void) {
    ...
    int n = 0;
    for(int i=0; i<64; i++){
        readBuffer[0] = I2C_Read1ByteRegister(0x69,(0x81 + pointer));
        readBuffer[1] = I2C_Read1ByteRegister(0x69,(0x80 + pointer));
        pointer = pointer + 2;
        Temp_Data[i] = Wertdetekt();
...
float Wertdetekt(void){
    ...
    tempDataAnz = tempData;
    tempDataAnz = tempDataAnz * 0.25L;
    return tempDataAnz;
}
